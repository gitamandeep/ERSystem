...
const Empoloyeeaside = () => {
  return (
    ...
    <nav>
      ...
      <NavLink to="/employeeprofile" className={({ isActive }) => isActive ? "font-bold" : ""}>
        <li className="mb-3">
          <div className='flex items-center font-medium hover:font-semibold hover:bg-gray-300 p-2 rounded-full'>
            ...
            <NavLink to="/employeechangepass" className={({ isActive }) => isActive ? "font-bold" : ""}>  
        <li className="mb-3">
          <div className='flex items-center font-medium hover:font-semibold hover:bg-gray-300 p-2 rounded-full'>
            <lord-icon
